...
void maingame()
{
    ...
    if (i > 1)
    {
        map.setObject(Array[1].getX(), Array[1].getY(), Zombie2);
        if (i > 2)
        {
            map.setObject(Array[2].getX(), Array[2].getY(), Zombie3);
            if (i > 3)
            {
                map.setObject(Array[3].getX(), Array[3].getY(), Zombie4);
                if (i > 4)
                {
                    map.setObject(Array[4].getX(), Array[4].getY(), Zombie5);
                    if (i > 5)
                    {
                        map.setObject(Array[5].getX(), Array[5].getY(), Zombie6);
                        if (i > 6)
                        {
                            map.setObject(Array[6].getX(), Array[6].getY(), Zombie7);
                            if (i > 7)
                            {
                                map.setObject(Array[7].getX(), Array[7].getY(), Zombie8);
                                if (i > 8)
                                {
                                    map.setObject(Array[8].getX(), Array[8].getY(), Zombie9);
                                }
                            }
                        }
                    }
        ...
        while (task > 0)
        {
            ...
            case 7:
            {
                ...
                if (myFile.is_open())
                {
                    ...
                    myFile << Array[0].getY() << '\n';
                    myFile << "ATK\n";
                    myFile << Array[0].getAtk() << '\n';
                    myFile << "HP\n";
                    myFile << Array[0].getHP() << '\n';
                    myFile << "Range\n";
                    myFile << Array[0].getAtkRange() << '\n';
                    myFile << defeated1 << '\n';
                    if (i > 1)
                    {
                        myFile << "zombie 2\n";
                        ...
                        myFile << Array[1].getY() << '\n';
                        myFile << "ATK\n";
                        myFile << Array[1].getAtk() << '\n';
                        myFile << "HP\n";
                        myFile << Array[1].getHP() << '\n';
                        myFile << "Range\n";
                        myFile << Array[1].getAtkRange() << '\n';
                        myFile << defeated2 << '\n';
                        if (i > 2)
                        {
                            myFile << "zombie 3\n";
                            ...
                            myFile << Array[2].getY() << '\n';
                            myFile << "ATK\n";
                            myFile << Array[2].getAtk() << '\n';
                            myFile << "HP\n";
                            myFile << Array[2].getHP() << '\n';
                            myFile << "Range\n";
                            myFile << Array[2].getAtkRange() << '\n';
                            myFile << defeated3 << '\n';
                            if (i > 3)
                            {
                                myFile << "zombie 4\n";
                                ...
                                myFile << Array[3].getY() << '\n';
                                myFile << "ATK\n";
                                myFile << Array[3].getAtk() << '\n';
                                myFile << "HP\n";
                                myFile << Array[3].getHP() << '\n';
                                myFile << "Range\n";
                                myFile << Array[3].getAtkRange() << '\n';
                                myFile << defeated4 << '\n';
                                if (i > 4)
                                {
                                    myFile << "zombie 5\n";
                                    ...
                                    myFile << Array[4].getY() << '\n';
                                    myFile << "ATK\n";
                                    myFile << Array[4].getAtk() << '\n';
                                    myFile << "HP\n";
                                    myFile << Array[4].getHP() << '\n';
                                    myFile << "Range\n";
                                    myFile << Array[4].getAtkRange() << '\n';
                                    myFile << defeated5 << '\n';
                                    if (i > 5)
                                    {
                                        myFile << "zombie 6\n";
                                        ...
                                        myFile << Array[5].getY() << '\n';
                                        myFile << "ATK\n";
                                        myFile << Array[5].getAtk() << '\n';
                                        myFile << "HP\n";
                                        myFile << Array[5].getHP() << '\n';
                                        myFile << "Range\n";
                                        myFile << Array[5].getAtkRange() << '\n';
                                        myFile << defeated6 << '\n';
                                        if (i > 6)
                                        {
                                            myFile << "zombie 7\n";
                                            ...
                                            myFile << Array[6].getY() << '\n';
                                            myFile << "ATK\n";
                                            myFile << Array[6].getAtk() << '\n';
                                            myFile << "HP\n";
                                            myFile << Array[6].getHP() << '\n';
                                            myFile << "Range\n";
                                            myFile << Array[6].getAtkRange() << '\n';
                                            myFile << defeated7 << '\n';
                                            if (i > 7)
                                            {
                                                myFile << "zombie 8\n";
                                                ...
                                                myFile << Array[7].getY() << '\n';
                                                myFile << "ATK\n";
                                                myFile << Array[7].getAtk() << '\n';
                                                myFile << "HP\n";
                                                myFile << Array[7].getHP() << '\n';
                                                myFile << "Range\n";
                                                myFile << Array[7].getAtkRange() << '\n';
                                                myFile << defeated8 << '\n';
                                                if (i > 8)
                                                {
                                                    myFile << "zombie 9\n";
                                                    ...
                                                    myFile << Array[8].getY() << '\n';
                                                    myFile << "ATK\n";
                                                    myFile << Array[8].getAtk() << '\n';
                                                    myFile << "HP\n";
                                                    myFile << Array[8].getHP() << '\n';
                                                    myFile << "Range\n";
                                                    myFile << Array[8].getAtkRange() << '\n';
                                                    myFile << defeated9 << '\n';
                                                    myFile << "obj" << '\n';
                                                    myFile << " " << '\n';
                                                }
            ...
            case 8:
            {
                ...
                if (defeated1 == 0)
                {
                    minDis = getDistance(curiosity.getX(), curiosity.getY(), Array[0].getX(), Array[0].getY());
                }
            ...
            case 28:
            {
                ...
                cout << "Alien give zombie 1 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 1 defeated" << endl;
            ...
            case 29:
            {
                ...
                cout << "Alien give zombie 2 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 2 defeated" << endl;
            ...
            case 30:
            {
                ...
                cout << "Alien give zombie 3 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 3 defeated" << endl;
            ...
            case 31:
            {
                ...
                cout << "Alien give zombie 4 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 4 defeated" << endl;
            ...
            case 32:
            {
                ...
                cout << "Alien give zombie 5 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 5 defeated" << endl;
            ...
            case 33:
            {
                ...
                cout << "Alien give zombie 6 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 6 defeated" << endl;
            ...
            case 34:
            {
                ...
                cout << "Alien give zombie 7 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 7 defeated" << endl;
            ...
            case 35:
            {
                ...
                cout << "Alien give zombie 8 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 8 defeated" << endl;
            ...
            case 36:
            {
                ...
                cout << "Alien give zombie 9 a damage of "
                     << " " << Alien.getATK() << endl;
                if (hpleft <= 0)
                {
                    cout << " Zombie 9 defeated" << endl;
            ...
            if (task >= 18 && task <= 27)
            {
                ...
                if (map.isInsideMap(targetX, targetY))
                {
                    ...
                    {
                        cout << "Zombie meets other zombie and stop moving" << endl;
                    }
                    else if (elm == '2')
                    {
                        cout << "Zombie meets other zombie and stop moving" << endl;
